...
type ServiceSso interface {
	Logout(params *LogoutParams) *ResponseLogout
	// ClientSignUp ClientSignUp(params *users.SignUpSAParams) (*users.ResponseClientSignUp, error)
	ClientSignUp(params *users.SignUpParams) (*users.ResponseClientSignUp, error)
	ClientSignIn(params *SignInSAParams) (*users.ResponseClientSignIn, error)
